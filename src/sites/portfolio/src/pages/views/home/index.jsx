                ...
                <WorkBox>
                    ...
                    <Carousel position="left">
                        <ProjectImageNavlink  to={`/works/${pageLast}`}>
                            <ProjectImage src={pageLast && worksFinished.find((work) => work.id === pageLast).image} alt={worksFinished.find((work) => work.id === pageLast).name} />
                        </ProjectImageNavlink>
                ...
                <WorkBox>
                    ...
                    <Carousel position="right">
                        <ProjectImageNavlink to={`/works/${pageActual}`}>
                            <ProjectImage src={pageActual && worksWorkingOn.find((work) => work.id === pageActual).image} alt={worksWorkingOn.find((work) => work.id === pageActual).name} />
                        </ProjectImageNavlink>
                        <PageButtonsContainer>
                            <RadioSection>
