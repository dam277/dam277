...
[
    {
        ...
        [
            ...
            { name : eFrameworks.electron.name, image : eFrameworks.electron.image, learned : true },
            ...
            { name : eFrameworks.astro.name, image : eFrameworks.astro.image, learned : true },
        ],
        libraries : 
        [
            { name : eLibraries.styledComponents.name, image : eLibraries.styledComponents.image, learned : true },
            { name : eLibraries.discordJs.name, image : eLibraries.discordJs.image, learned : true },
            { name : eLibraries.cypress.name, image : eLibraries.cypress.image, learned : true },
    ...
    },
    {
        ...
        [
            ...
            { name : eFrameworks.maui.name, image : eFrameworks.maui.image, learned : false },
        ],
        libraries : 
        [
    ...
    },
    {
        ...
        languages : 
        [
            { name : eLanguages.swift.name, image : eLanguages.swift.image, learned : false },
        ],
        frameworks : 
        [],
        libraries : 
    ...
    },
    {
        ...
        languages : 
        [
            { name : eLanguages.python.name, image : eLanguages.python.image, learned : true },
        ],
        frameworks : 
        [
            { name : eFrameworks.django.name, image : eFrameworks.django.image, learned : false },
            { name : eFrameworks.flask.name, image : eFrameworks.flask.image, learned : true },
        ],
        libraries : 
        [
            { name : eLibraries.discordPy.name, image : eLibraries.discordPy.image, learned : true },
            { name : eLibraries.sqlalchemy.name, image : eLibraries.sqlalchemy.image, learned : true },
        ]
    },
    {
        learned : false,
...
[
    {
        ...
        engines : 
        [
            { name : eEngines.unrealEngine.name, image : eEngines.unrealEngine.image, learned : false },
        ],
        languages : 
        [],
        libraries : 
